...
import "../easter-egg/easter-egg.css";
...
export default function EasterEgg() {
  ...
  const shotScale =
    phase === "flood" ? 1.6 + floodProgress * 3 : 1.05 + flightProgress * 0.45;
  ...
  return (
    <>
      ...
      {showOverlay && (
        <div
          className={`egg-overlay ${fadeOut ? "is-fading" : ""}`}
          aria-hidden="true"
        >
          <div
            className="egg-liquid"
            style={{ "--egg-flood-progress": floodProgress }}
          >
